...
sudo apt-get update
sudo apt-get -y install neovim thunderbird screen nmap net-tools zsh openssh-server gvfs-bin i3 py3status fish playerctl python3-pip clang-format virtualbox --fix-missing
